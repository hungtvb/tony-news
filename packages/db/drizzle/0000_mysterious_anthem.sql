...
CREATE UNIQUE INDEX "articles_source_article_id_uq" ON "articles" USING btree ("source_id","source_article_id") WHERE "articles"."source_article_id" is not null;--> statement-breakpoint
